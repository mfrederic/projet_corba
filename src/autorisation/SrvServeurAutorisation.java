...
public class SrvServeurAutorisation {
	public static void main(String[] args) {
		try {
		        ...
		        byte[] monServeurAutorisationId = rootPOA.activate_object(monServeurAutorisation);
		        ...
		        nameRoot.rebind(nameToRegister,rootPOA.servant_to_reference(monServeurAutorisation));
		        System.out.println("==> Nom '"+ nomObj + "' est enregistre dans le service de noms.");

		/*
		        String IORServant = orb.object_to_string(rootPOA.servant_to_reference(monServeurAutorisation));
